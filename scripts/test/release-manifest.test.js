...
test('repository release identity is beta 0.4.0-beta.4 on 2026-09-18', async () => {
  ...
  assert.equal(version, '0.4.0-beta.4');
...
test('validator permits only a beta.N version on the beta channel', async () => {
  ...
  const beta = {
    ...manifest,
    productVersion: '0.4.0-beta.4',
    channel: 'beta',
    releaseNotesUrl: 'https://github.com/TheGoldenWave/Follow-up/releases/tag/v0.4.0-beta.4',
  };
