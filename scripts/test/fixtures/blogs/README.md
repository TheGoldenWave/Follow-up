...
| Google Antigravity | `https://antigravity.google/blog/rss.xml` | Browser-verified RSS and article `/blog/teamwork-when-ai-becomes-a-research-partner` dated 2026-08-27; reduced RSS item retained |
...
| Google Research | `https://research.google/blog/rss/` | Browser-verified RSS and article `/blog/transfer-learning-for-genomic-prediction-in-underrepresented-populations/` dated 2026-09-03; reduced RSS item retained |
...
| Perplexity Research | `https://research.perplexity.ai/` | Browser-verified current root index and article `/articles/securing-agents-across-perplexity’s-client-endpoints-with-numbat` dated 2026-07-29; the old `/articles` index redirects to the Cloudflare/new Hub experience |
...
Browser verification used the signed-in app browser because the Node CLI environment still reports environment-specific DNS or connection failures for these endpoints. Those CLI failures do not replace the browser-observed official URLs captured above.
